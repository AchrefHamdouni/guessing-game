...
function validateGuess(guess){
    if (isNaN(guess)){
        ...
        if (numGuesses === 11){
            ...
            displayMessage(`Game Over! The Criminal runs away, it's ID# was 071521${randomNumber}`);
            endGame();
        } else {
...
function checkGuess(guess){
    if (guess === randomNumber){
        displayMessage(`You guessed correctly! Criminal's ID# was 071521${randomNumber}`);
        endGame();
